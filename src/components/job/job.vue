        ...
        <el-main style="padding:0px;">
            <Split :gutterSize="5">
                <SplitArea :size="sizes[0]" :minSize="0" style="overflow:hidden;background:#f2f2f2;">
                    <TagTreeView :model="{domain:'jobrun'}" :fun="onRefreshByTag" ref="jobrunTagTree"></TagTreeView>
                </SplitArea>
                        ...
                        <el-main style="padding-top:30px;">
                            ...
                            <el-table
                                            ...
                                            <div v-else>
                                                <div v-if="item.field=='cmds'">
                                                    <el-popover
                                                        ...
                                                        popper-class="info-popper"
                                                        :popper-options="{ boundariesElement: 'body' }">
                                                        <el-input type="textarea" rows="6" :value="scope.row[item['field']][0]"></el-input>
                                                        <!--el-container>
                                                            <el-main style="padding:0px;">
                                                                <VueEditor
                                                                    :value="scope.row[item['field']][0]"
                                                                    @init="onEditorInit"
                                ...
                                <el-table-column label="操作" width="60" fixed="right">
                                    <template slot-scope="scope">
                                        <el-tooltip content="执行情况" placement="top">
                                            <el-button type="success" style="padding:3px 6px;" @click="onDiagnosis(scope.row)" icon="el-icon-tickets" size="mini"></el-button>
                                        </el-tooltip>
    ...
    data(){
        ...
        return {
            ...
            search: {
                ...
                result: null,
                time: {
                    range: [this.moment().add(-24*7,'hour').format('YYYY-MM-DD HH:mm'),this.moment().format('YYYY-MM-DD HH:mm')],
                    options: {
                        shortcuts:[
                            {
                                text: '最近15分钟',
        ...
        */
        ...
        onDelete(row){
            ...
            this.$msgbox({
                ...
                this.m3.callFS("/matrix/m3job/deleteLog.js", encodeURIComponent(JSON.stringify(row))).then( ()=>{
                    this.onRefresh();
                } );
